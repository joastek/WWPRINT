      ...
      >
        ...
        <div className="poster_container">
          ...
          <div className="second_part">
            Oferujemy różne szerokości kaset Roll Up, aby spełnić Twoje
            potrzeby:{" "}
            <ul>
              {" "}
              <li>
              ...
              <li>
                {" "}
                Kasety o szerokości 100 cm: Doskonałe do standardowych
                prezentacji i wystaw.
              </li>
              <li>
                {" "}
                120 cm: Zapewniają większą powierzchnię do wyeksponowania
                treści, idealne dla bardziej rozbudowanych projektów.
              </li>
              Kasety o szerokości
            </ul>
